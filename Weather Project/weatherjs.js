...
$("#myTextBox").click(function(){
    $.getJSON('https://query.yahooapis.com/v1/public/yql?q=select * from weather.forecast where woeid in (select woeid from geo.places(1) where text="san diego, ca")&format=json',function(xy){ $('#result').html(xy);});
